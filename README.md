# Comunicação entre atividades - Atividade 3 do 1o Bimestre de SO 2026.2
...
- **Data de apresentação**: 30/09/2026
---
## Tarefas
1. Montar os grupos;
2. Fork desse repositório (cada membro pode ter seu repositório _forked_ mas apenas terá um link aqui);
3. Fazer um `pull request` atualizando esse arquivo README.md com a URL do repositório oficial da equipe 
...
| Java       | Guilherme da Silva Cruz<br>José Vine Nunes Martins Araújo<br>Maria Clara Batista Viana Silva   | [Repositório Java](https://github.com/cruzguilherme1-rpg/Fork-atividade-avaliativa_03_java) |
